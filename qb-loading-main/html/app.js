...
const load = Vue.createApp({
  setup () {
    return {
      ...
      CarouselSubText1: 'Photo captured by: OfficerMills',
      CarouselText2: 'Adding additional player data can be achieved by modifying the qb-core player.lua file.',
      CarouselSubText2: 'Photo captured by: OfficerMills',
      CarouselText3: 'All server-specific adjustments can be made in the config.lua files throughout the build.',
      CarouselSubText3: 'Photo captured by: OfficerMills',
      CarouselText4: 'For additional support please join our community at discord.gg/OneWorldRP',
      CarouselSubText4: 'Photo captured by: OfficerMills',

      DownloadTitle: 'Loading One World RP',
      DownloadDesc: "Welcome to One World Role Play, an 18+ Serious RP server dedicated to immersive storytelling, custom scripts, and a vibrant community. \n\nExplore unique jobs, businesses, and activities while forging your story in a world shaped by you.",
